...
class TestFluxMeasurements:
    ...
    def test_fit_cont(self):
        ...
        line = lime.Line.from_transition('O1_6300A_b', cfg['default_line_fitting'], spec.frame, norm_flux=spec.norm_flux)
        ...
        line = lime.Line.from_transition('O2_3726A_b', cfg['default_line_fitting'], spec.frame, norm_flux=spec.norm_flux)
