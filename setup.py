...
setup(
    ...
    package_dir={'': 'src'},
    package_data={'': ['config.cfg', 'types_params.txt', '_parent_mask.txt', 'LogitistRegression_v2_cost1_logNorm.joblib', 'src/resources/*']},
    # package_data={'':          ['config.cfg', 'types_params.txt', '_parent_mask.txt', 'resources/GradientDescent_v2_cost1_logNorm.joblib'],
    #               'resources': ['resources/*']},
