...
# Fit the continuum
gp_spec.fit.continuum(degree_list=[3, 6, 6], emis_threshold=[3, 2, 1.5], plot_steps=True, log_scale=False)
...
gp_spec.fit.frame(obj_bands_file, obs_cfg, obj_conf_prefix='gp121903_osiris', line_detection=True)
