...
# Outputs
log_file = 'log_CGCG007_v2.5.fits'
...
# Create MUSE
cgcg007 = lime.Cube.from_file(cube_file, instrument='muse', redshift=z_obj)

# Show the data and the masks
cgcg007.check.cube('H1_6563A', masks_file=mask_file, rest_frame=True, fname=log_file)
