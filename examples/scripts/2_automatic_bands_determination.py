...
#
# obj_linesDF = gp_spec.retrieve.lines_frame(band_vsigma=200, n_sigma=4, line_list=['H1_4861A', 'O3_5007A', 'H1_6563A'],
#                                            map_origin=["none", 'MW'], vacuum_waves=True)
#
# lime.save_frame(f'combined_dataframe.txt', obj_linesDF)
#
# gp_spec.plot.spectrum(bands=obj_linesDF, log_scale=True)
#
#
# # map_origin = {None: dict(line_list=['H1_4861A', 'O3_5007A', 'H1_6563A'], redshift=None),
# #               'Obj2': dict(line_list=['H1_4861A', 'O3_5007A', 'H1_6563A'], redshift=z_obj*2)}
# #
# # obj_linesDF = gp_spec.retrieve.lines_frame(map_origin=map_origin)
# #
# # print(obj_linesDF)
# #
# # lime.save_frame(f'combined_dataframe_dict.txt', obj_linesDF)
# #
# # gp_spec.plot.spectrum(bands=obj_linesDF, log_scale=True)
#
#
# # line_list = lime.Line.from_list(['H1_4861A', 'H1_4861A_o-MW', 'O3_5007A', 'O3_5007A_o-MW', 'H1_6563A', 'H1_6563A_o-MW'])
# # for line in line_list:
# #     print(line, line.origin, line.redshift)
# #
# #
# # obj_linesDF = gp_spec.retrieve.lines_frame(line_list=line_list)
# #
# # print(obj_linesDF)
# #
# # lime.save_frame(f'combined_dataframe_dict.txt', obj_linesDF)
