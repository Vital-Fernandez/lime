...
# Fit the line with a Lorentz profile
gp_spec.clear_data()
gp_spec.fit.bands('H1_6563A', obj_bands, profile='l')
gp_spec.plot.bands('H1_6563A')

# Or using the line name
gp_spec.clear_data()
gp_spec.fit.bands('H1_6563A_p-l', bands=obj_bands)
gp_spec.plot.bands('H1_6563A_p-l')
