...
lime.MaskSelector(lines_log_address=corrected_lineMaskFile, lines_DF=maskDF,
...
lime.MaskSelector(lines_log_address=corrected_lineMaskFile, lines_DF=lines_log_section,
                  input_wave=wave, input_flux=flux, redshift=z_obj, norm_flux=norm_flux)
