...
# Function to display the progress bar on the terminal
...
shoc579.spatial_masker('O3_4363A', param='SN_line', percentiles=[93, 96, 99], header_dict=hdr, output_address=spatial_mask)
