...
# shoc579.check.cube(6563, line_fg=6563, wcs=WCS(hdr), percentil_bg=60, percentils_fg=[80, 90, 95, 99])
...
# shoc579.plot.cube('H1_6563A', line_fg=4363, percentiles_fg=[93, 96, 99], masks_file=spatial_mask, wcs=wcs)
