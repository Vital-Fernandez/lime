...
lime.save_parameter_maps(output_lines_log_file, param_list, lines_list, output_folder='./sample_data/',
                         spatial_mask_file=spatial_mask_file, output_files_prefix='SHOC579_', wcs=wcs)
